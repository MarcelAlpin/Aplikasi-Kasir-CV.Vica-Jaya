<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="flex items-center h-16">
        <!-- Sidebar Toggle - absolutely positioned at left -->
        <button @click="$dispatch('toggle-sidebar')" class="p-4 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white focus:outline-none">
