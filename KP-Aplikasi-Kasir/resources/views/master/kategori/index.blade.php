                    ...
                    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                        ...
                        <table class="w-full text-left table-auto border-collapse">
                            ...
                            <tbody>
                                    ...
                                    <tr class="text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-2 border dark:border-gray-600">
                                            <div class="flex space-x-2">
                                                ...
                                                <button type="button" onclick="openDeleteModal({{ $kategori->id }})" class="text-red-500 hover:underline">Hapus</button>
                                            </div>

                                            <!-- Delete confirmation modal (will be positioned fixed in middle of screen) -->
                                            <div id="deleteModal{{ $kategori->id }}" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-4 py-2 text-center text-gray-500 dark:text-gray-400">Belum ada data kategori.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
